...
<body>
	...
	<div class="row justify-content-md-center">
		...
		<div class="col-md-auto">
			<h1 class="logo">Sorting Wizard</h1>
		</div>
	</div>
	</div>
		...
		<div class=" col-md-auto sidebar" id="canvasFigureSidebar">
			<ul class="list-group list-group-horizontal-xl optionSize">
				...
				<a target="_blank" href="https://github.com/mrasgania/Sorting-Wizard">More Details</a>
				</li>
	...
	<div class="container-fluid ">
		...
		<p class="develop">Designed and Developed by &nbsp <a target="_blank"
				<a target="_blank" href="https://www.linkedin.com/in/mayank-rasgania-758085213/"> Mayank Rasgania </a> </p>
	</div>
	</div>
